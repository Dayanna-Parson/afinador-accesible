...
Sol grave (Low G, sin reentrancia) y la afinación Re tradicional. Low G requiere montar una
cuerda Low G específica; no se logra aflojando una cuerda Sol estándar una octava. La afinación
Re sube la tensión de todas las cuerdas y requiere un juego diseñado para ella.
